...
// Handle updating order payment status
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update_order'])) {
    ...
    if ($update_pay->execute([$update_payment, $order_id])) {
        $_SESSION['success_msg'] = 'Order payment status updated!';
    } else {
        $_SESSION['error_msg'] = 'Failed to update order payment status.';
    }
}
            ...
            <div class="box-container">
                ...
                if ($select_order->rowCount() > 0) {
                    ...
                    while ($fetch_order = $select_order->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        <div class="box">
                            <!-- Order status -->
                            <div class="status" style="color: <?= $fetch_order['payment_status'] == 'in progress' ? 'limegreen' : 'coral'; ?>">
                            ...
                            <!-- Form for updating payment status and deleting order -->
                            <form action="<?= htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                ...
                                <select name="update_payment">
                                    ...
                                    <option value="complete" <?= $fetch_order['payment_status'] == 'complete' ? 'selected' : ''; ?>>Complete</option>
                                </select>
...
<!-- <div class="status" style="color: <?= $fetch_order['order_status'] == 'in progress' ? 'limegreen' : 'coral'; ?>">
